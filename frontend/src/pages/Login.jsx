  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4">
      ...
      >
        ...
        <h2 className="text-3xl font-bold text-center mb-2 text-slate-800">System Access</h2>
        <p className="text-center text-slate-500 mb-8">AI Medicare Control System</p>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            type="submit"
            className="w-full py-3.5 mt-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-medium hover:shadow-lg hover:shadow-cyan-500/30 transition-all relative overflow-hidden group"
          >
        ...
        <p className="text-center mt-6 text-sm text-slate-500">
          New medical personnel? <Link to="/register" className="text-cyan-600 font-medium hover:underline hover:text-cyan-700">Request Access</Link>
        </p>
      </motion.div>
    </div>
  );
